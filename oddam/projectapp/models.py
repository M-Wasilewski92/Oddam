...
class Donation(models.Model):
    ...
    institution = models.ForeignKey(
        Institution, on_delete=models.CASCADE, verbose_name="Instytucja"
    )
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, verbose_name="Użytkownik"
    )
    is_taken = models.BooleanField(
        default=False, null=True, verbose_name="Datek przekazany"
    )
